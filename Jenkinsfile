    ...
    stages {
        ...
        stage('Push') {
            steps {
                ...
                withCredentials([[$class: 'AmazonWebServicesCredentialsBinding', accessKeyVariable: 'AKIAU63EMJYQ4O646JQX', credentialsId: "System", secretKeyVariable: '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']]) {
